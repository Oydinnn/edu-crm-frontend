...
export default function Sidebar() {
  ...
  const menuItems = [
    { id: "dashboard", name: t("main"), icon: HomeIcon, path: "/dashboard" },
    {
      id: "teachers",
      name: t("teachers"),
      icon: SchoolIcon,
    ...
    { id: "groups", name: t("groups"), icon: GroupIcon, path: "/groups" },
    {
      id: "students",
      name: t("students"),
      icon: PersonIcon,
            ...
            <ul className="space-y-2">
              ...
              <li ref={dropdownRef} className="relative">
                <button
                  ...
                  ${isSettingsActive || isSettingsOpen ? "bg-[#1f39a1] dark:bg-blue-600 text-white shadow-md" : "text-[#4a5568] dark:text-gray-300 hover:bg-[#f0f4ff] dark:hover:bg-slate-800 hover:text-[#1f39a1] dark:hover:text-blue-400"}`}
                >
                  <SettingsIcon
                    className={`w-5 h-5 transition-transform ${isSettingsOpen && !isCollapsed ? "rotate-90" : ""}`}
                  />
                  {!isCollapsed && (
                    <span className="flex-1 text-left">{t("management")}</span>
                  )}
                  {!isCollapsed && (
                    <span
                ...
                {!isCollapsed && (
                  <div
                    className={`fixed left-64 top-0 w-64 h-full bg-white dark:bg-slate-900 border-l border-gray-150 dark:border-slate-800 shadow-2xl z-20 py-3 flex flex-col 
    transition-all duration-500 ease-in-out transform
    ${isSettingsOpen ? "translate-x-0 opacity-100 visible" : "-translate-x-4 opacity-0 invisible"}`}
                  >
                    {/* Sarlavha qismi */}
                    <div className="px-4 pb-3 border-b border-gray-100 dark:border-slate-800 font-semibold text-gray-800 dark:text-white flex justify-between items-center">
                      <span>Menu</span>
                      <button
                      ...
                      {settingsItems.map((item) => (
                        <NavLink
                          ...
                          className={({ isActive }) =>
                            ...
                            ${isActive && !isSettingsOpen ? "bg-[#1f39a1] dark:bg-blue-600 text-white" : "text-gray-600 dark:text-gray-300 hover:bg-blue-50 dark:hover:bg-slate-850 hover:text-[#1f39a1] dark:hover:text-blue-400"}`
                          }
                        >
        ...
        {!isCollapsed && (
          <div className="p-6">
            <div className="bg-gradient-to-r from-[#f0f4ff] to-red-50 dark:from-slate-800 dark:to-slate-800/60 rounded-xl shadow-sm p-4 border border-gray-100 dark:border-slate-800 transition-colors duration-300">
              ...
              <div className="mb-4">
                ...
                <div className="w-full bg-gray-200 dark:bg-slate-700 rounded-full h-2">
                  <div
                    className="bg-[#1f39a1] dark:bg-blue-600 h-2 rounded-full"
                    style={{ width: "16%" }}
                  />
                </div>
              </div>
              <button className="w-full bg-[#1f39a1] dark:bg-blue-600 hover:bg-[#162870] dark:hover:bg-blue-700 text-white font-normal py-2 px-2 rounded-lg transition-all duration-300 shadow-md hover:shadow-lg flex items-center justify-center gap-2 cursor-pointer">
                <span>🔄</span> {t("renew_sub")}{" "}
              </button>
